...
DLLEXPORT extern rfbBool webSocketsHasDataInBuffer(rfbClientPtr cl);
#endif
...
DLLEXPORT extern rfbLogProc rfbLog, rfbErr;
 ...
 */
#ifdef WIN32
DLLEXPORT rfbBool rfbProcessNewConnection(rfbScreenInfoPtr rfbScreen, fd_set* fds);
#else // WIN32
